...
def test_linear_forward():
    ...
    Z, linear_cache = P.linear_forward(activations, weights, biases)
...
def test_linear_activation_forward_with_sigmoid():
    ...
    Z, cache = P.linear_activation_forward(prev_activations, weights, biases, A.sigmoid)
...
def test_linear_activation_forward_with_relu():
    ...
    Z, cache = P.linear_activation_forward(prev_activations, weights, biases, A.relu)
...
def test_forward_propagation():
    ...
    last_activations, cache = P.forward_propagation(net, prev_activations, parameters)
...
def test_linear_backward():
    ...
    prev_activation_derivatives, weight_derivatives, bias_derivatives = P.linear_backward(dZ, linear_cache)
...
def test_linear_activation_backward():
    ...
    prev_activation_derivatives, weight_derivatives, bias_derivatives = P.linear_activation_backward(last_activations_derivative, linear_activation_cache, A.sigmoid)
    ...
    prev_activation_derivatives, weight_derivatives, bias_derivatives = P.linear_activation_backward(last_activations_derivative, linear_activation_cache, A.relu)
...
def test_backward_propagation():
    ...
    grads = P.backward_propagation(net, last_activations, labels, caches)
