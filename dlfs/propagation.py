...
def initialize_parameters(net: Network):
    """
    Arguments:
    ...
    for l in range(1, num_layers):
        parameters['W' + str(l)] = I.variance_scaled((network_dimensions[l], network_dimensions[l-1]), network_dimensions[l-1])
        parameters['b' + str(l)] = I.zeros((network_dimensions[l], 1))
...
def forward_propagation(net, X, parameters):
    """
    ...
    for l in range(1, L):
        A_prev = A
        A, cache = linear_activation_forward(A_prev, parameters['W' + str(l)], parameters['b' + str(l)], net.layers[l].activation)
        caches.append(cache)

    # Implement LINEAR -> SIGMOID. Add "cache" to the "caches" list.
    AL, cache = linear_activation_forward(A, parameters['W' + str(L)], parameters['b' + str(L)], net.layers[L].activation)
...
def backward_propagation(net, AL, Y, caches):
    """
    ...
    grads["dA" + str(L-1)], grads["dW" + str(L)], grads["db" + str(L)] = linear_activation_backward(dAL, current_cache, net.layers[L].activation)

    for l in reversed(range(L-1)):
        # lth layer: (RELU -> LINEAR) gradients.
        current_cache = caches[l]
        dA_prev_temp, dW_temp, db_temp = linear_activation_backward(grads["dA" + str(l + 1)], current_cache, net.layers[l+1].activation)
